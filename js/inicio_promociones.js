...
window.ValtaraPromoBook = window.ValtaraPromoBook || {
  ...
  therapies: [{"id": "relajante50", "name": "Masaje Relajante Neuro Adaptativo", "duration": "50 Minutos", "price": 699, "icon": "fa-spa", "color": "#00ffe0", "desc": "Relajación profunda para disminuir ansiedad, estrés físico y agotamiento emocional. Movimientos fluidos, ritmos lentos y una sensación de descanso real para el sistema nervioso."}, {"id": "relajante90", "name": "Masaje Relajante Neuro Adaptativo", "duration": "90 Minutos", "price": 899, "icon": "fa-moon", "color": "#6ee7ff", "desc": "Versión extendida para quienes necesitan más tiempo de contención, silencio corporal y restauración profunda. Ideal para burnout y sobrecarga mental."}, {"id": "deportivo", "name": "Masaje Deportivo & Descompresión", "duration": "50 Minutos", "price": 729, "icon": "fa-dumbbell", "color": "#ff5555", "desc": "Liberación muscular profunda para contracturas, sobrecarga física y rigidez acumulada por entrenamiento, trabajo repetitivo o tensión sostenida."}, {"id": "tailandes", "name": "Masaje Tailandés · Yoga Pasivo", "duration": "50 Minutos", "price": 729, "icon": "fa-person-praying", "color": "#4cc9f0", "desc": "Estiramientos asistidos y presión estratégica para recuperar movilidad, aflojar cadenas musculares y disminuir sensación de cuerpo pesado."}, {"id": "ayurveda", "name": "Ayurveda & Aromaterapia", "duration": "50 Minutos", "price": 829, "icon": "fa-leaf", "color": "#F2C94C", "desc": "Aceites tibios, aromas botánicos y maniobras calmantes para ansiedad, fatiga emocional y necesidad de reconectar con el cuerpo."}, {"id": "holistico", "name": "Masaje Holístico Integrativo", "duration": "50 Minutos", "price": 829, "icon": "fa-yin-yang", "color": "#FFD700", "desc": "Experiencia enfocada en equilibrio físico y emocional, con presión media y una intención profunda de armonizar cuerpo, respiración y mente."}, {"id": "lomi", "name": "Ritual Lomi Lomi Supremo", "duration": "Sesión Premium", "price": 999, "icon": "fa-water", "color": "#ffaa00", "desc": "Ritual inmersivo inspirado en el oleaje hawaiano. Movimientos continuos, fluidez sensorial y una sensación de desconexión total del estrés."}, {"id": "esferas", "name": "Esferas Chinas & Velas Aromáticas", "duration": "60 Minutos", "price": 719, "icon": "fa-circle-notch", "color": "#ffffff", "desc": "Vibración sonora, luz cálida y una atmósfera de calma diseñada para regular el ritmo interno y relajar profundamente el sistema nervioso."}, {"id": "facial", "name": "Terapia para Parálisis Facial", "duration": "45 Minutos", "price": 529, "icon": "fa-face-smile", "color": "#4361EE", "desc": "Estimulación neuromuscular enfocada en recuperación funcional, relajación de compensaciones y apoyo al retorno de movilidad facial."}, {"id": "drenaje", "name": "Drenaje Linfático Manual", "duration": "60 Minutos", "price": 749, "icon": "fa-droplet", "color": "#d6d6d6", "desc": "Movilización suave para sensación de ligereza, apoyo al retorno de líquidos y una experiencia corporal delicada y respetuosa."}, {"id": "reductivo", "name": "Reductivo & Maderoterapia", "duration": "Sesión / Paquete", "price": 799, "icon": "fa-child-reaching", "color": "#b27fff", "desc": "Protocolos corporales de estética manual con geles especializados y maderoterapia para acompañar objetivos de bienestar corporal."}, {"id": "shiatsu", "name": "Shiatsu en Cama · Complemento", "duration": "20 Minutos", "price": 199, "icon": "fa-chair", "color": "#ffffff", "desc": "Complemento ideal para acompañantes o como extensión en terapias elegibles. Presión estratégica en cuello, hombros y espalda alta."}],

  aromas: [{"name": "Lavanda", "extra": 0, "note": "Relajación profunda"}, {"name": "Vainilla", "extra": 49, "note": "Calidez y suavidad"}, {"name": "Menta", "extra": 39, "note": "Sensación fresca"}, {"name": "Eucalipto", "extra": 39, "note": "Respiración despejada"}, {"name": "Rosas Blancas", "extra": 59, "note": "Experiencia premium"}],

  promos: [{"id": "off169", "name": "$169 de cortesía", "detail": "Lunes y martes, primeras 10 sesiones después de la 1 PM.", "value": 169, "type": "fixed"}, {"id": "off20", "name": "20% OFF matutino", "detail": "Jueves a domingo antes de las 2 PM.", "value": 20, "type": "percent"}],
  ...
  calc() {
    ...
    const subtotal = therapy.price + (aroma.extra || 0);
    let discount = 0;
  ...
  go(step) {
    const steps = document.querySelectorAll('.vtp-step');
    ...
    if (aromaBox) {
      aromaBox.innerHTML = `
        <div class="vtp-selected-chip">
          ...
          <span>${r.aroma.extra > 0 ? '+' + this.money(r.aroma.extra) : 'Incluida'}</span>
        </div>
      `;
    }
  },
  ...
  renderSummary() {
    ...
    summary.innerHTML = `
      ...
      <div class="vtp-line"><span>Aromaterapia</span><strong>${r.aroma.name}</strong></div>
...
<section class="vtp-shell" id="inicio_promociones_top">
  <style>
    ...
    .vtp-selected-chip strong {
      color: var(--valtara-blanco);
    }
    .vtp-selected-chip span {
      color: var(--valtara-cian-brillante);
    }
    .vtp-summary-box {
      padding: 1rem 1.1rem;
    ...
    @media (max-width: 720px) {
      .vtp-hero, .vtp-step-head, .vtp-step-body {
        padding-left: .9rem;
        padding-right: .9rem;
      }
      .vtp-step-head {
  ...
  <section class="vtp-hero">
    <div class="vtp-kicker"><i class="fa-solid fa-book-open fa-fade"></i> Promociones inteligentes</div>
  ...
  <div class="vtp-board">
    ...
    <div class="vtp-chip"><strong><i class="fa-solid fa-map-location-dot"></i> Ubicaciones</strong>Reforma 195 y próxima apertura cerca de Metro Eugenia.</div>
  </div>
  ...
  <div class="vtp-book">
    <section class="vtp-step" id="vtp-step-1">
      <div class="vtp-step-head">
        ...
        <div>
          ...
          <p class="vtp-desc">Las terapias están organizadas con precios oficiales ajustados y descripciones más amplias para ayudarte a elegir con claridad.</p>
        </div>
      </div>
    ...
    <section class="vtp-step" id="vtp-step-2" hidden>
      <div class="vtp-step-head">
        ...
        <div>
          ...
          <p class="vtp-desc">Puedes mantener una experiencia neutra o sumar una nota sensorial para intensificar la sensación de calma y descanso.</p>
        </div>
      </div>
      <div class="vtp-step-body">
        ...
        <div class="vtp-actions">
          <button class="vtp-btn back" type="button" onclick="window.ValtaraPromoBook.go(1)"><i class="fa-solid fa-arrow-left"></i> Regresar</button>
        </div>
      </div>
    </section>
    ...
    <section class="vtp-step" id="vtp-step-3" hidden>
      ...
      <div class="vtp-step-body">
        ...
        <div class="vtp-note">
          <strong>Términos:</strong> la cortesía de $169 MXN aplica lunes y martes, primeras 10 sesiones después de la 1 PM. El 20% matutino aplica jueves a domingo antes de las 2 PM. No son acumulables. Después de las 7 PM algunas experiencias incluyen té de frutos rojos.
        </div>
        <div class="vtp-actions">
          <button class="vtp-btn back" type="button" onclick="window.ValtaraPromoBook.go(2)"><i class="fa-solid fa-arrow-left"></i> Regresar</button>
        </div>
      </div>
    </section>
    ...
    <section class="vtp-step" id="vtp-step-4" hidden>
      <div class="vtp-step-head">
        ...
        <div>
          ...
          <p class="vtp-desc">Aquí verás el subtotal, el descuento y el total estimado calculado con la terapia, el aroma y la promoción elegida.</p>
        </div>
      </div>
      <div class="vtp-step-body">
        <div id="vtp-summary" class="vtp-summary-box"></div>
        <div class="vtp-actions">
          <a id="vtp-whatsapp" class="vtp-btn primary" target="_blank" rel="noopener noreferrer" href="#"><i class="fa-brands fa-whatsapp"></i> Continuar por WhatsApp</a>
          <button class="vtp-btn back" type="button" onclick="window.ValtaraPromoBook.go(3)"><i class="fa-solid fa-arrow-left"></i> Regresar</button>
        </div>
      </div>
    </section>
  </div>
...
window.ValtaraModulos.inicio_promociones = window.ValtaraModulos.inicio_promociones || VT_PROMOCIONES_HTML;
window.ValtaraPromoBook.renderSelection();
window.ValtaraPromoBook.renderSummary();
